...
flowchart TD
    ...
    Client -->|HTTP requests| Caddy["Caddy<br/>API Gateway / Load Balancer"]
...
The final architecture provides a scalable and observable foundation for the simulated emergency resource coordination system. It demonstrates service replication, load balancing, shared caching, asynchronous messaging, health monitoring, structured logging, Prometheus metrics, and Grafana-based observability within a Docker Compose environment.
